...
def get_processed_kvs(sample, keys=None, required_keys=None):
    item = {
        ...
        "sub_task": sample.get("sub_task", "masked_restoration"),
...
def get_default_dataset():
    return GujiGenerationDataset(
        loc=resolve_repo_data_path("chain_of_thought", "missing_character_completion.json"),
        sub_task="masked_restoration",
