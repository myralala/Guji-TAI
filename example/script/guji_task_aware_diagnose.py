...
def run(dataset_name: str, model_name: str, sample_index: int, selected_methods=None, target_mode: str = "auto"):
    ...
    return {
        ...
        "results": results,
        "fused_result": fuse_explanations(list(results.values())),
    }
